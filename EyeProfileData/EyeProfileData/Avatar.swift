...
class Avatar: NSObject {
	...
	// Layers
	static var shapeImages = [#imageLiteral(resourceName: "shape1"),#imageLiteral(resourceName: "shape3"),#imageLiteral(resourceName: "shape4"),#imageLiteral(resourceName: "shape5"),#imageLiteral(resourceName: "shape6"),#imageLiteral(resourceName: "shape7")]
